    ...
    <Fragment>
      ...
      <Form layout='horizontal' footer={
        ...
        <Form.Item label='公司名称' name='compony' rules={[{ required: true, message: '公司名称必须指定' }]}>
          <Input onChange={value => handleRecruitmentInfo('company', value)} placeholder='请输入公司名称' />
        </Form.Item>
        <Form.Item label='职位薪资' name='salary' rules={[{ required: true, message: '职位薪资必须指定' }]}>
          <Input onChange={value => handleRecruitmentInfo('salary', value)} placeholder='请输入职位薪资' />
        </Form.Item>
